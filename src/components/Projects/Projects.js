...
const Projects = (props) => {
  return (
    <div id="projects">
      ...
      <ProjectItem projectData={props.projectData[1]} projectImage={props.projectImages.wellsyImage}/>
      <ProjectItem projectData={props.projectData[2]} projectImage={props.projectImages.packathonImage}/>
      <ProjectItem projectData={props.projectData[3]} projectImage={props.projectImages.catsweeperImage}/>
